...
/**
 * Import Items Script
 * This script will import all items from the item_list table
 * It handles duplicates by using INSERT IGNORE
 */
...
if ($table_check->num_rows == 0) {
    die("Error: item_list table does not exist. Please run database.sql first.");
}

// Items data array
$items = [
    [7, 'ANE8', 'UNIT', 0, 'ANCHOR, EXPANDING, 8 -WAYS, HOT DIP GALVANIZED', 1, 1, '2023-10-08 16:35:58'],
    [8, 'ANLOGW', 'UNIT', 0, 'ANCHOR, LOG, WOOD 8" X 4\' ', 100, 1, '2023-10-08 16:36:17'],
    [9, 'ANLOGC', 'UNIT', 0, 'ANCHOR, LOG, CONCRETE, 8" X 4\' ', 100, 1, '2023-10-08 16:36:36'],
    [10, 'ANSC348', 'UNIT', 0, 'ANCHOR, SCREW EYE SHAFT, 3/4" X 8\', HDG, FORGED ', 100, 1, '2023-10-08 16:36:55'],
    [11, 'ANSH34', 'UNIT', 0, 'ANCHOR, SHACKLE, 3/4", DROP FORGED STEEL, 69KV ', 91, 1, '2023-10-08 16:37:12'],
    [12, 'ATTG1116', 'UNIT', 0, 'ATTACHMENT, GUY, MALLEABLE TYPE WITH 11/16', 100, 1, '2023-10-08 16:37:34'],
    [17, 'BOLTM588', 'PCS', 0, 'BOLT, MACHINE 5/8" X 8", HOT DIP GALVANIZED ', 51, 1, '2023-11-03 18:22:41'],
    [18, 'BOLTM5810', 'PCS', 0, 'BOLT, MACHINE 5/8" X 10", HOT DIP GALVANIZED ', 100, 1, '2023-11-03 18:23:08'],
    [19, 'BOLTOE5810', 'PCS', 0, 'BOLT, OVAL EYE 5/8" X 10", HOT DIP GALVANIZED, FORGED ', 100, 1, '2023-11-03 18:25:04'],
    ...
    [22, 'BOLTDUPST5810', 'PCS', 0, 'BOLT, DOUBLE UPSET 5/8" X 10", HOT OLP GALVANIZED, FORGED ', 41, 1, '2023-11-03 18:26:36'],
    [23, 'WASHERSF223', 'PCS', 0, 'WASHER SQUARE 2¼ X 2¼', 100, 1, '2023-11-05 03:42:38'],
    [24, 'WASHERSF441', 'PCS', 0, 'WASHER SQUARE 4X4X½', 100, 1, '2023-11-05 03:43:32'],
    ...
    [29, 'NUTE58CON', 'PCS', 0, 'NUT, EYE, 5/8", CONVENTIONAL, HOT DIP GALVANIZED ', 100, 1, '2023-11-05 03:54:55'],
    [30, 'RODATSE587', 'PCS', 0, 'ROD, ANCHOR, THREADED, SINGLE EYE, 5/8" X 7\', HOT DIP GALVANIZED, FORGED ', 100, 1, '2023-11-05 03:56:57'],
    [31, 'BOLTM1210', 'PCS', 0, 'BOLT, MACHINE 1/2" X 10", HOT DIP GALVANIZED ', 100, 1, '2023-11-05 03:57:55'],
    [32, 'BOLTSUPS5810', 'PCS', 0, 'BOLT, SINGLE UPSET 5/8" X 10", HOT DIP GALVANIZED, FORGED ', 100, 1, '2023-11-05 04:00:03'],
    [33, 'RODGS5810', 'PCS', 0, 'ROD, GROUND STEEL, GALVANIZED, 5/8" X 10\', HOT DIP GALVANIZED ', 100, 1, '2023-11-05 04:01:42'],
    [34, 'CLAMPDES2', 'PCS', 0, 'CLAMP, DEAD-END STRAIN, #2 ACSR ', 100, 1, '2023-11-05 04:02:03'],
    [35, 'INSSUS652-1', 'PCS', 0, 'INSULATOR, SUSPENSION, 6", ANSI CLASS 52-1 ', 100, 1, '2023-11-05 04:02:22'],
    ...
    [39, 'INSSPOOL53-1', 'PCS', 0, 'INSULATOR, SPOOL, 1-3/8", ANSI, CLASS 53-1 ', 100, 1, '2023-11-05 04:17:15'],
    [40, 'INSSPOOL53-4', 'PCS', 0, 'INSULATOR, SPOOL, 3", ANSI, CLASS 53-4 ', 100, 1, '2023-11-05 04:18:57'],
    [41, 'NUTLOCK38', 'PCS', 0, 'NUT, LOCK, MF TYPE, 3/8" ', 100, 1, '2023-11-05 04:19:22'],
    [42, 'RODATE110', 'PCS', 0, 'ROD, ANCHOR, THIMBLE EYE, 1" X 10\', HOT DIP GALVANIZED, FORGED ', 100, 1, '2023-11-05 04:20:09'],
    [43, 'WASHERSC442', 'PCS', 0, 'WASHER, SQUARE, CURVED, 4" X 4" X 1/2" W/ 7/8" DIA. HOLE ', 100, 1, '2023-11-05 04:22:59'],
    [44, 'BOLTCR384', 'PCS', 0, 'BOLT, CARRIAGE 3/8" X 4-1/2", HOT DIP GALVANIZED ', 81, 1, '2023-11-05 04:23:41'],
    [45, 'BOLTM5812', 'PCS', 0, 'BOLT, MACHINE 5/8" X 12", HOT DIP GALVANLZED ', 100, 1, '2023-11-05 04:26:52'],
    [46, 'BRACEX18D48S', 'PCS', 0, 'BRACE CROSS-ARM, 18" DROP 48" SPAN ', 100, 1, '2023-11-05 04:27:23'],
    [47, 'BRACEX18D60S', 'PCS', 0, 'BRACE CROSS-ARM, 18" DROP 60" SPAN ', 100, 1, '2023-11-05 04:29:20'],
    ...
    [50, 'SHACKLEACH58', 'PCS', 0, 'SHACKLE, ANCHOR, 5/8", FORGED STEEL, HOT DIP GALVANIZED ', 100, 1, '2023-11-05 04:39:49'],
    [51, 'BOLTARM5824', 'PCS', 0, 'BOLT, DOUBLE ARMING 5/8" X 24", HOT DIP GALVANIZED ', 100, 1, '2023-11-05 04:40:59'],
    [52, 'BOLTM126', 'PCS', 0, 'BOLT, MACHINE 1/2" X 6", HOT OLP GALVANIZED ', 100, 1, '2023-11-05 04:41:45'],
    [53, 'BOLTM586', 'PCS', 0, 'BOLT, MACHINE 5/8" X 6", HOT OLP GALVANIZED', 100, 1, '2023-11-05 04:42:19'],
    [54, 'BOLTOE5812', 'PCS', 0, 'BOLT, OVAL EYE 5/8" X 12", HOT DIP GALVANIZED, FORGED ', 100, 1, '2023-11-05 04:46:58'],
    [55, 'BOLTOE5818', 'PCS', 0, 'BOLT, OVAL EYE 5/8" X 18", HOT DIP GALVANIZED, FORGED ', 100, 1, '2023-11-05 04:47:28'],
    ...
    [61, 'XARMS348', 'PCS', 0, 'CROSSARM, STEEL, 3" X 4" X 8\', HOT DIP GALVANIZED ', 100, 1, '2023-11-05 05:04:06'],
    [62, 'INSSPOOL53-2', 'PCS', 0, 'INSULATOR, SPOOL, 1-3/4", ANSI, CLASS 53-2 ', 100, 1, '2023-11-05 05:07:28'],
    [63, 'NUTLOCK12', 'PCS', 0, 'NUT, LOCK, MF TYPE, 1/2" ', 100, 1, '2023-11-05 05:10:06'],
    [64, 'NUTLOCK58', 'PCS', 0, 'NUT, LOCK, MF TYPE, 5/8" ', 100, 1, '2023-11-05 05:10:38'],
    [65, 'WIRETAPEA', 'MTR', 0, 'WIRE, TAPE, ARMOR, ALUMINUM ALLOY, 0.5" X 0.3" (FEET) ', 100, 1, '2023-11-05 05:11:24'],
    [66, 'WASHERR138', 'PCS', 0, 'WASHER, ROUND, 1-3/8" DIAMETER WITH 9/16" DIAMETER HOLE', 100, 1, '2023-11-05 05:12:29'],
    ...
    [71, 'WIREGS38', 'MTR', 0, 'WIRE, GUY, STEEL, 3/8", 7 STRAND, HIGH STRENGTH (METERS) ', 100, 1, '2023-11-05 05:22:44'],
    ...
    [74, 'PINPOLETOP20', 'PCS', 0, 'PIN, POLE TOP, CHANNEL, 1" THREAD, 20" LONG, HOT DIP GALVANIZED ', 100, 1, '2023-11-05 05:34:56'],
    ...
    [78, 'C&ABRACKETL', 'PCS', 0, 'CUTOUT & ARRESTER BRACKET L-TYPE', 100, 1, '2023-11-05 19:42:10'],
    [79, 'AMPSTIR4', 'PCS', 22, 'AMPACT STIRRUP 4/0', 106, 1, '2023-11-05 19:43:12'],
    [80, 'BOLTARM5822', 'PCS', 0, 'BOLT, DOUBLE ARMING 5/8" X 22", HOT DIP GALVANIZED ', 100, 1, '2023-11-06 00:49:01'],
    [81, 'BOLTM5814', 'PCS', 0, 'BOLT, MACHINE 5/8" X 14", HOT OLP GALVANIZED ', 100, 1, '2023-11-06 00:50:16'],
    ...
    [87, 'CONGRCLMP58', 'PCS', 0, 'CONNECTOR, GROUND ROD CLAMP, 5/8" ', 100, 1, '2023-11-06 01:03:36'],
    [88, 'FCOLA100', 'SET', 0, 'FUSE CUT-OUT & ARRESTER COMBINATION, 15KV, CLASS 100 ', 100, 1, '2023-11-06 01:04:58'],
    ...
    [92, 'PINXS5813', 'PCS', 0, 'PIN, CROSSARM, STEEL, 5/8" X 13-3/4", HOT DIP GALVANIZED ', 100, 1, '2023-11-06 01:13:04'],
    ...
    [96, 'SPACERP34', 'PCS', 0, 'SPACER, PIPE, 3/4" X 1-1/2", HOT DIP GALVANIZED ', 100, 1, '2023-11-06 01:22:26'],
    [97, 'WASHERC3313', 'PCS', 0, 'WASHER, CURVED, 3" X 3" X 1/4", 13/16 ', 100, 1, '2023-11-06 01:23:24'],
    ...
    [100, 'WIREG3', 'FEET', 0, 'WIRE, GROUNDING, GALVANIZED, 3 STRAND, 5/16" DIA. (FEET) ', 100, 1, '2023-11-06 06:58:18'],
    [101, 'NUTLOCK34', 'PCS', 0, 'NUT, LOCK, MF TYPE, 3/4" ', 100, 1, '2023-11-06 07:02:24'],
    ...
    [108, 'BRACKETMFCO', 'SET', 0, 'BRACKET, MOUNTING FOR FUSE CUT-OUT & ARRESTER ', 100, 1, '2023-11-08 07:59:27'],
    ...
    [119, 'RSCCOUP', '', 0, 'RSC COUPLING 2 1/2"', 100, 1, '2023-11-17 03:38:52'],
    ...
    [122, 'EXBOLT', '', 0, 'EXPANSION BOLT 3/4"', 100, 1, '2023-11-17 03:41:00'],
...
// Prepare statement
$stmt = $conn->prepare("INSERT IGNORE INTO item_list (id, description, unit, price, name, stocks, status, date_created) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
...
foreach ($items as $item) {
    $stmt->bind_param("issdssis", $item[0], $item[1], $item[2], $item[3], $item[4], $item[5], $item[6], $item[7]);
    
    if ($stmt->execute()) {
        if ($stmt->affected_rows > 0) {
            $inserted++;
        } else {
            $skipped++; // Item already exists
        }
    } else {
        $errors++;
        echo "Error inserting item ID {$item[0]}: " . $stmt->error . "<br>";
    }
}
...
<html>
<head>
    <title>Import Items - Results</title>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            <li class="list-group-item d-flex justify-content-between">
                                ...
                                <strong class="text-success"><?php echo $inserted; ?></strong>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Items Skipped (Already Exist):</span>
                                <strong class="text-warning"><?php echo $skipped; ?></strong>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Errors:</span>
                                <strong class="text-danger"><?php echo $errors; ?></strong>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                        ...
                        <div class="mt-3">
                            <a href="/items/items.php" class="btn btn-primary">View Items</a>
